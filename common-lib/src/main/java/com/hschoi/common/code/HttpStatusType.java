...
public enum HttpStatusType implements EnumType {
  ...
  , UNAUTHORIZED_REQUEST("ADMIN_004","허가되지않은 요청입니다.", 403)
  , REGIST_REQUIRED_ACCOUNT("ADMIN_005","등록할 패스워드를 입력해 주세요.", 400)
  , REGIST_REQUIRED_PASSWORD("ADMIN_006","등록할 패스워드를 입력해 주세요.", 400)
  , REGIST_REQUIRED_USERTYPE("ADMIN_007","유저의 타입(승객/기사)을 입력해 주세요.", 400)  
  , INVALID_USERTYPE("ADMIN_008","올바른 유저타입이 아닙니다. (DRIVER/PASSENGER) 중 입력해 주세요.", 401)
